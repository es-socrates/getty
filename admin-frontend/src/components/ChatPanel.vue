  ...
  <section class="admin-tab active" role="form">
    <OsCard class="mb-4" aria-describedby="chat-desc">
      ...
      <div class="mt-3" :aria-labelledby="colorHeadingId">
        ...
        <div
          class="os-surface p-3 rounded-os border border-[var(--card-border)] bg-[var(--bg-card)] mb-3"
          aria-labelledby="general-colors-heading">
          <h4
            id="general-colors-heading"
        ...
        <div
          class="os-surface p-3 rounded-os border border-[var(--card-border)] bg-[var(--bg-card)] mb-3"
          aria-labelledby="username-colors-heading">
          <h4
            id="username-colors-heading"
            class="text-xs font-semibold uppercase tracking-wide mb-2">
            {{ t('usernameColors') || 'Username' }}
          </h4>
          <div class="mb-2">
            <label class="inline-flex items-center gap-2 text-sm cursor-pointer select-none">
        ...
        <div
          class="os-surface p-3 rounded-os border border-[var(--card-border)] bg-[var(--bg-card)]"
          aria-labelledby="donation-colors-heading">
          <h4
            id="donation-colors-heading"
            class="text-xs font-semibold uppercase tracking-wide mb-2">
    ...
    <OsCard class="mt-4" :title="t('testMessages') || 'Test messages'">
      <div class="flex flex-wrap items-center gap-2 mb-3 text-xs" aria-live="polite">
        <span
          class="inline-flex items-center gap-1 px-2 py-0.5 rounded border border-[var(--card-border)] bg-[var(--bg-chat)]">
          <strong>AR</strong>
        ...
        <span
          class="inline-flex items-center gap-1 px-2 py-0.5 rounded border border-[var(--card-border)] bg-[var(--bg-chat)]"
          :title="'Tried: ' + price.providersTried.join(', ')">
      ...
      <div class="flex gap-2 mt-2">
        <button class="btn" :disabled="testSending" @click="sendTest('message')">
          {{
        ...
        <button class="btn" :disabled="testSending" @click="sendTest('donation')">
          {{
...
import ChatThemeManager from './ChatThemeManager/ChatThemeManager.vue';
