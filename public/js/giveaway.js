  ...
  if (raffleData.winner) {
        ...
        <div class="winner-display">
            <div class="winner-flex-row">
                ...
                <div class="winner-info-area">
                    ...
                    <div class="winner-timestamp text-gray-400 text-sm" id="winnerTimestamp">${
                      raffleData.timestamp
                        ? (() => {
    ...
    if (winnerNames.length > 2) {
      ...
      function showNextWinner() {
        ...
        setTimeout(() => {
          fadeElem.textContent =
            winnerNames[idx].length > 12 ? winnerNames[idx].slice(0, 12) + '…' : winnerNames[idx];
