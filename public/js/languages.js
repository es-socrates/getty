const languages = {
    en: {
        announcementSidebar: "Announcements",
        announcementTitle: "Announcement Messages",
        announcementThemeLabel: "Theme:",
        announcementThemeVertical: "Vertical",
        announcementThemeHorizontal: "Horizontal",
        announcementCooldownLabel: "Rotation cooldown (minutes):",
        announcementCooldownHint: "Time between random announcements.",
        announcementAnimationLabel: "Animation:",
        announcementAnimFade: "Fade",
        announcementAnimSlideUp: "Slide Up",
        announcementAnimSlideLeft: "Slide Left",
        announcementAnimScale: "Scale",
        announcementAnimRandom: "Random",
        announcementDefaultDurationLabel: "Default display time (seconds):",
        announcementDefaultDurationHint: "Used for new messages when no specific duration is set.",
        announcementApplyAllLabel: "Apply this default to all existing messages now",
        announcementDurationLabel: "Display time (seconds):",
        announcementDurationHint: "Between 1 and 60 seconds (default 10).",
        announcementCreateMessage: "Create Message",
        announcementTextLabel: "Message (Markdown)",
        announcementTextPlaceholder: "Your message **supports** _markdown_ and links",
        announcementTextHint: "Max 120 characters. Supports **bold**, _italic_, and [links](https://example.com).",
        announcementImageLabel: "Image (optional)",
        announcementImageHint: "PNG, JPG or GIF. Max 512KB.",
        announcementLinkLabel: "Link (optional)",
        announcementLinkPlaceholder: "https://example.com",
        announcementLinkHint: "If set, a favicon + link will be shown below the message.",
        announcementAddBtn: "Add message",
        announcementEditBtn: "Update message",
        announcementPreviewBtn: "Preview",
        announcementCancelEdit: "Cancel edit",
        announcementMessageAdded: "Message added",
        announcementMessageUpdated: "Message updated",
        announcementSettingsSaved: "Settings saved",
        announcementRemoveImage: "Remove image",
        announcementValidationRequired: "Message required",
        announcementValidationTooLong: "Max 120 characters",
        announcementErrorGeneric: "Error",
        announcementInvalidCooldown: "Invalid cooldown",
        announcementMessagesList: "Messages",
        announcementWidgetUrlLabel: "Announcement Widget URL:",
        announcementNoMessages: "No messages yet.",
        announcementClearTest: "Clear test messages",
        announcementClearAll: "Delete all messages",
        announcementConfirmClearTest: "Delete test/demo messages?",
        announcementConfirmClearAll: "Delete ALL messages?",
        announcementClearedTest: "Test messages removed",
        announcementClearedAll: "All messages removed",
        announcementSaveSettings: "Save settings",
        announcementSettingsTitle: "Settings",
    ...
    es: {
        announcementSidebar: "Anuncios",
        announcementTitle: "Mensajes de anuncio",
        announcementThemeLabel: "Tema:",
        announcementThemeVertical: "Vertical",
        announcementThemeHorizontal: "Horizontal",
        announcementCooldownLabel: "Intervalo de rotación (minutos):",
        announcementCooldownHint: "Tiempo entre anuncios aleatorios.",
        announcementAnimationLabel: "Animación:",
        announcementAnimFade: "Desvanecer",
        announcementAnimSlideUp: "Deslizar Arriba",
        announcementAnimSlideLeft: "Deslizar Izquierda",
        announcementAnimScale: "Escalar",
        announcementAnimRandom: "Aleatoria",
        announcementDefaultDurationLabel: "Tiempo por defecto (segundos):",
        announcementDefaultDurationHint: "Se usa para nuevos mensajes si no se especifica duración.",
        announcementApplyAllLabel: "Aplicar este valor a todos los mensajes existentes ahora",
        announcementDurationLabel: "Tiempo en pantalla (segundos):",
        announcementDurationHint: "Entre 1 y 60 segundos (por defecto 10).",
        announcementCreateMessage: "Crear mensaje",
        announcementTextLabel: "Mensaje (Markdown)",
        announcementTextPlaceholder: "Tu mensaje **soporta** _markdown_ y enlaces",
        announcementTextHint: "Máx 120 caracteres. Soporta **negrita**, _cursiva_ y [enlaces](https://example.com).",
        announcementImageLabel: "Imagen (opcional)",
        announcementImageHint: "PNG, JPG o GIF. Máx 512KB.",
        announcementLinkLabel: "Enlace (opcional)",
        announcementLinkPlaceholder: "https://ejemplo.com",
        announcementLinkHint: "Si se define, se mostrará favicon + enlace debajo del mensaje.",
        announcementAddBtn: "Agregar mensaje",
        announcementEditBtn: "Actualizar mensaje",
        announcementPreviewBtn: "Vista previa",
        announcementCancelEdit: "Cancelar edición",
        announcementMessageAdded: "Mensaje agregado",
        announcementMessageUpdated: "Mensaje actualizado",
        announcementSettingsSaved: "Configuración guardada",
        announcementRemoveImage: "Quitar imagen",
        announcementValidationRequired: "Mensaje requerido",
        announcementValidationTooLong: "Máx 120 caracteres",
        announcementErrorGeneric: "Error",
        announcementInvalidCooldown: "Intervalo inválido",
        announcementMessagesList: "Mensajes",
        announcementWidgetUrlLabel: "URL del widget de anuncios:",
        announcementNoMessages: "Sin mensajes todavía.",
        announcementClearTest: "Limpiar mensajes de prueba",
        announcementClearAll: "Eliminar todos los mensajes",
        announcementConfirmClearTest: "¿Eliminar mensajes de prueba/demostración?",
        announcementConfirmClearAll: "¿Eliminar TODOS los mensajes?",
        announcementClearedTest: "Mensajes de prueba eliminados",
        announcementClearedAll: "Todos los mensajes eliminados",
        announcementSaveSettings: "Guardar configuración",
        announcementSettingsTitle: "Configuración",
