...
try { console.warn(`i18n runtime generated: js/min/i18n-runtime.js (version ${hash})`); } catch {}
...
try {
  ...
  try { console.warn('i18n runtime minified: js/min/i18n-runtime.min.js'); } catch {}
} catch (e) {
...
try {
  ...
  htmlTargets.forEach(file => {
    ...
    if (pattern.test(content)) {
      ...
      updatedCount++;
  try { console.warn(`Updated i18n runtime version in ${path.relative(projectRoot, file)}`); } catch {}
    }
  });
  if (!updatedCount) {
